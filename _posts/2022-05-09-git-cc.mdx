...
publishedTime: '2022-05-08T16:26:00Z'
...
が一定のルールで記述されるので、Conventional Commitsに則ってメッセージを作成することで理解しやすいコミットを自然と作成できることがメリットだと感じています（逆に、変更内容が伝わるコミットメッセージをつけられるようなコミットの粒度を意識するように矯正できるとも言えます）。
